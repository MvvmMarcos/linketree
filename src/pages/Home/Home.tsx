    ...
    <div className="flex flex-col w-full py-4 items-center justify-center">
      ...
      <main className="flex flex-col w-11/12 max-w-xl text-center">
        ...
        {links && links.map((link) => (
          <section key={link.id} className="bg-white mb-4 w-full py-2 rounded-lg select-none transition-transform hover:scale-105 cursor-pointer" style={{ background: link.bg }}>
